<script lang="ts">
  ...
  let newSampleInputPlaceholder = "Use arg1 = ..., arg2 = ... and click away to add";

  const autoGeneratedSharedSampleTemplates = new Set<string>([
    "crypto-shift-inference-v2",
    "crypto-substitution-inference-v2",
  ]);

  let sharedSampleArgLocked = false;
  ...
  $: sharedSampleArgLocked =
    !!match && autoGeneratedSharedSampleTemplates.has(match.template_key);
  $: newSampleInputPlaceholder = sharedSampleArgLocked
    ? "Use arg1 = ... and click away to add"
    : "Use arg1 = ..., arg2 = ... and click away to add";
    ...
    <div class="game-layout">
      ...
      <section class="editor-panel">
        ...
        {#if submitResult}
          ...
          {#if submitResult.verdict === "sample_failed"}
            <button
              type="button"
